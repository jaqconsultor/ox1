...
public class GenerateReportAction extends TabBaseAction implements IForwardAction { 
	...
	public void execute() throws Exception {
		if (!("pdf".equals(getType()) || "xlsx".equals(getType()) || "pptx".equals(getType()) || "csv".equals(getType()) || "xls".equals(getType()))) {
            throw new XavaException("report_type_not_supported", getType(), "xlsx, pptx, pdf, csv, xls");
        }
